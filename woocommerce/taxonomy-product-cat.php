...
<?php
if(have_rows('category_additional_content','product_cat_'.$term->term_id)){
	...
	$create_additional_category_content .= '<div class="category-description-inner-layout-wrap">';
					...
					$i=0;
					while(have_rows('category_additional_content','product_cat_'.$term->term_id)) : the_row();
    ...
    <div class="section">
		<div class="category-banner-section">
			<?php
			$category_banner_image = get_field("category_banner_image",'product_cat_'.$term->term_id);
			$category_banner_text = get_field("category_banner_text",'product_cat_'.$term->term_id);
		...
		?>
			<div class="product-grid<?php if(!empty($check_filters_data) || !empty($check_filters_data2)){?> grid-3<?php }else{?> grid-4<?php }?> grid md-flex-grid">
				...
				<div class="grid-content-outer-wrap">
					<div id = "wt-grid-content" class="product-grid group justify-left">
